...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\TBAInfo\functions", "$global:testroot\..\TBAInfo\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\TBAInfo\functions"
    "$global:testroot\..\TBAInfo\internal\functions"
)
